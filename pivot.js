...
var pivot = (function () {
    ...
    var fields, filters, rawData, data, dataFilters, displayFields, results, currencySymbolField, resultsColumns;
    ...
    */
    function init(options) {
        ...
        if (options.currencySymbolField !== undefined) currencySymbolField = options.currencySymbolField;
        if (options.defaultCurrencySymbol !== undefined) defaultCurrencySymbol = options.defaultCurrencySymbol;
